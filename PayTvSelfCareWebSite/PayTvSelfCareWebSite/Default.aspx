...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="slider" id="slider1">
        <!-- Slides -->
        <div style="background-image: url(images/banners/welcome-slider.png)" class="responsive"></div>
        <div style="background-image: url(images/banners/hd-banner.png)" class="responsive"></div>
        <div style="background-image: url(images/banners/EnjoySlider.png)" class="responsive"></div>
        <div style="background-image: url(images/banners/AppView-Slider.png); cursor: pointer" id="Download" class="responsive"></div>

        <div style="background-image: url(images/banners/choose-chennels.png)" class="responsive"></div>
        <div style="background-image: url(images/banners/tv-shows.png)" class="responsive"></div>
        <!-- The Arrows -->
        ...
        <div class="container">
            <div class="row">
                <div class="site-title mb-50">
                    ...
                    <h4 class="nex-undertitle">At SHREE DIGITAL CABLE SYSTEM, we strive to create a better experience for our viewers.
                        <br />
                        We offer channels of all genres in SD &amp; HD variants to keep our Subscribers
                        <br />
                        Entertained, Enlightened and Evolved.</h4>
                </div>
                ...
                <div class="col-md-12 mt-40" id="Div1">
                    ...
                    <div class="col-sm-6 m-t-60-xs-max p-l-45-sm-min p-l-75-md-min " id="Div5" style="text-align: left">
                        <div class="col-inner">
                            <div class="section-heading align-c-xs-max mt-60">
                ...
                <div class="col-md-12 mt-40" id="Div6">
                    <div class="col-sm-6" id="Div7" style="display: none">
                        <div class="col-inner">
                            <div class="section-heading align-c-xs-max ">
                                <h2>Sports</h2>
                                <%--<h5>Simple and Responsive</h5>--%>
                    ...
                    <div class="col-sm-6 m-t-60-xs-max p-l-45-sm-min p-l-75-md-min">
                        <div class="col-inner wow fadeInRight clearfix">
                            <img class="img-responsive float-r-sm-min m-x-auto-xs-max" src="images/homepage/mockup.png" alt="" data-sr="right" data-sr-id="7" style="visibility: visible; -webkit-transform: translateX(0); opacity: 1; transform: translateX(0); opacity: 1; -webkit-transition: -webkit-transform 0.8s ease-in-out 0s, opacity 0.8s ease-in-out 0s; transition: transform 0.8s ease-in-out 0s, opacity 0.8s ease-in-out 0s;" />
                        </div>
                    </div>
                    <div class="col-sm-6 mt-40" id="Div8" style="text-align: right">
                        <div class="col-inner">
                            <div class="section-heading align-c-xs-max mt-50">
                                <h2>Download Now !</h2>
                                <%--<h5>Simple and Responsive</h5>--%>
                            ...
                            <!-- .section-heading -->
                            <div class="section-content">
                                <p>Pay Tv SelfCare - a single window to the world of CableTv. Now at your FINGERTIPS to manage all your channels, payments and queries.</p>
                            </div>
                            <!-- .section-content -->
                            <div class="downloadbtn mt-20">
                                <a target="" href="http://itunes.apple.com/app/id1455593984" class="mr-10">
                                    <img src="images/homepage/appstore.png" />
                                </a>

                                <a target="_blank" href="https://play.google.com/store/apps/details?id=com.reliable.paytvselfcare&hl=en">
                                    <img src="images/homepage/playstore.png" />
                                </a>
                            </div>
                            <div>
                            </div>
